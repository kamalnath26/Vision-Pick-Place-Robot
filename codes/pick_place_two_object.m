...
Px100.DEVICENAME = 'COM8'; % Replace 'COM11' with the correct port if needed
...
dropPositionBase_2 = trvec2tform([0.15, -0.1, 0.12]); % Example drop position
...
approachPositionBase_2 = dropPositionBase * trvec2tform([0, 0, 0.16]); % 0.1 m above drop position
