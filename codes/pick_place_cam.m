...
pickPositionBase = trvec2tform([pickPositionBase(1,4),-pickPositionBase(2,4), 0.07]);
dropPositionBase = trvec2tform([dropPositionBase(1,4),-dropPositionBase(2,4), 0.07]);
